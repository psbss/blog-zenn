...
AIによってドキュメント（README、手順書、ナレッジ、Tips、オンボーディング資料）がリアルタイムに自動で生成される時代になってきました。ここ最近では[Devin wiki](https://docs.devin.ai/work-with-devin/devin-wiki)等の超強力なドキュメント生成ツールも登場し、いよいよドキュメントを書く必要性が薄れてきたと感じます。
